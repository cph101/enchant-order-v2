    ...
    return (
        <main>
            <footer className="custom-content footer bg-foreobject">
                ...
                <p>
                    <a
                        onClick={() => document.getElementById("creditsModal").showModal()}
                        className="text-link"
                        data-trnskey="credits"
                    >
                        Credits
                    </a>{" "}
                    |{" "}
          ...
          ">
                        <div className="basis-1/10 my-auto">
                            <img
                                ...
                                src="https://avatars.githubusercontent.com/u/173750?v=4"
                            />
                        </div>
          ...
          ">
                        <div className="basis-1/10 my-auto">
                            <img
                                className="rounded-full h-6"
                                src="https://avatars.githubusercontent.com/u/79333877?v=4"
                            />
                        </div>
                        <div className="basis-9/10 my-auto ml-2">
          ...
          ">
                        <div className="basis-1/10 my-auto">
                            <img
                                className="rounded-full h-6"
                                src="https://avatars.githubusercontent.com/u/93673699?v=4"
                            />
                        </div>
                        <div className="basis-9/10 my-auto ml-2">

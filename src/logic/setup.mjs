...
import { getEnchants, getStoredEnchants } from "./bridge.mjs";
...
const item_filepath = "./examples/low_level_boots.json"; // filepath for JSON file with enchanted items to be merged
